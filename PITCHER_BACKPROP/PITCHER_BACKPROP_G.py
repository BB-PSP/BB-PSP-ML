...
pitching_info = mlb_pitchingstats[['Age','W','L','ERA','G','SV','HLD','IP','TBF','WHIP','BABIP','LOB_PCT']]
...
b_x = pitching_info[['Age','W','L','ERA','SV','HLD','IP','TBF','WHIP','BABIP','LOB_PCT']]
b_y = pitching_info[['G']]
...
b_csv = b_csv[b_csv['IP'] < 100]
                                                     ...
                                                     #KBO 타자 데이터
b_kbo_x = b_csv[['Age','W','L','ERA','SV','HLD','IP','TBF','WHIP','BABIP','LOB_PCT']]
b_kbo_y = b_csv[['G']]
