...
pitching_info = mlb_pitchingstats[['Age','ERA','G','SV','BS','HLD','IP','TBF','H','R','ER','HR','BB','HBP','WP','SO','H_9','HR_9','WHIP','BABIP','LOB_PCT','FIP']]

b_x = pitching_info[['Age','ERA','G','SV','BS','IP','TBF','H','R','ER','HR','BB','HBP','WP','SO','H_9','HR_9','WHIP','BABIP','LOB_PCT','FIP']]
b_y = pitching_info[['HLD']]
...
b_kbo_x = b_csv[['Age','ERA','G','SV','BS','IP','TBF','H','R','ER','HR','BB','HBP','WP','SO','H_9','HR_9','WHIP','BABIP','LOB_PCT','FIP']]
b_kbo_y = b_csv[['HLD']]
