...
pitching_info = mlb_pitchingstats[['Age','W','L','ERA','G','GS','CG','ShO','SV','BS','HLD','IP','TBF','H','R','ER','HR','BB','HBP','SO','K_9','WHIP','BABIP']]

b_x = pitching_info[['Age','W','L','ERA','G','GS','CG','ShO','SV','BS','HLD','IP','TBF','H','R','ER','HR','BB','HBP','SO','K_9','BABIP']]
...
b_kbo_x = b_csv[['Age','W','L','ERA','G','GS','CG','ShO','SV','BS','HLD','IP','TBF','H','R','ER','HR','BB','HBP','SO','K_9','BABIP']]
b_kbo_y = b_csv[['WHIP']]
