...
pitching_info = mlb_pitchingstats[['Age','W','L','ERA','GS','CG','ShO','SV','BS','HLD','H','R','ER','HR','BB','IBB','HBP','K_9','BB_9','HR_9','WHIP','BABIP','LOB_PCT','FIP']]

b_x = pitching_info[['Age','W','ERA','GS','CG','ShO','SV','BS','HLD','H','R','ER','HR','BB','IBB','HBP','K_9','BB_9','HR_9','WHIP','BABIP','LOB_PCT','FIP']]
b_y = pitching_info[['L']]
...
plt.scatter(b_y_test, b_y_predict, alpha=0.4)
plt.xlabel("Real")
...
b_kbo_x = b_csv[['Age','W','ERA','GS','CG','ShO','SV','BS','HLD','H','R','ER','HR','BB','IBB','HBP','K_9','BB_9','HR_9','WHIP','BABIP','LOB_PCT','FIP']]
b_kbo_y = b_csv[['L']]
