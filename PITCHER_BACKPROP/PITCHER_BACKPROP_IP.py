...
pitching_info = mlb_pitchingstats[['Age','W','L','ERA','G','GS','CG','ShO','SV','BS','HLD','IP','HR','BB','IBB','HBP','WP','BK','SO','BABIP','LOB_PCT','FIP']]

b_x = pitching_info[['Age','W','L','ERA','G','GS','CG','ShO','SV','BS','HLD','HR','BB','IBB','HBP','WP','BK','SO','BABIP','LOB_PCT','FIP']]
b_y = pitching_info[['IP']]
...
b_kbo_x = b_csv[['Age','W','L','ERA','G','GS','CG','ShO','SV','BS','HLD','HR','BB','IBB','HBP','WP','BK','SO','BABIP','LOB_PCT','FIP']]
b_kbo_y = b_csv[['IP']]
