...
batting_info = mlb_battingstats[['Age','G','AB','PA','H','HR','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG']]

b_x = batting_info[['Age','G','AB','PA','H','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG']]
b_y = batting_info[['HR']]
...
b_kbo_x = b_csv[['Age','G','AB','PA','H','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG']]
b_kbo_y = b_csv[['HR']]
