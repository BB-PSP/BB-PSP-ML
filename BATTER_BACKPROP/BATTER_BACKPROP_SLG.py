...
batting_info = mlb_battingstats[['Age','G','AB','PA','H','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG','OBP','SLG','BABIP']]

b_x = batting_info[['Age','G','AB','PA','H','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG','OBP','BABIP']]
...
b_kbo_x = b_csv[['Age','G','AB','PA','H','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG','OBP','BABIP']]
b_kbo_y = b_csv[['SLG']]
