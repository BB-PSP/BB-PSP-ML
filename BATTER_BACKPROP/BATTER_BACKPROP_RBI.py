...
batting_info = mlb_battingstats[['Age','G','PA','H','HR','R','RBI','BB','IBB','SO','SF','SH','GDP','SB','CS','AVG','OBP','SLG','BABIP']]

b_x = batting_info[['Age','G','PA','H','HR','R','BB','IBB','SO','SF','SH','GDP','SB','CS','AVG','OBP','SLG','BABIP']]
b_y = batting_info[['RBI']]
...
b_kbo_x = b_csv[['Age','G','PA','H','HR','R','BB','IBB','SO','SF','SH','GDP','SB','CS','AVG','OBP','SLG','BABIP']]
b_kbo_y = b_csv[['RBI']]
