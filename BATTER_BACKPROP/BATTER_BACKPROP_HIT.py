...
batting_info = mlb_battingstats[['Age','G','AB','R','H','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS']]

b_x = batting_info[['Age','G','AB','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS']]
b_y = batting_info[['H']]
...
b_kbo_x = b_csv[['Age','G','AB','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS']]
b_kbo_y = b_csv[['H']]
