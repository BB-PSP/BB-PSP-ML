...
batting_info = mlb_battingstats[['Age','G','PA','HR','R','RBI','IBB','SO','HBP','SF','SH','GDP','SB','CS','OBP','ISO','BABIP']]

b_x = batting_info[['Age','G','PA','HR','R','RBI','IBB','SO','HBP','SF','SH','GDP','SB','CS','ISO','BABIP']]
b_y = batting_info[['OBP']]
...
b_kbo_x = b_csv[['Age','G','PA','HR','R','RBI','IBB','SO','HBP','SF','SH','GDP','SB','CS','ISO','BABIP']]
b_kbo_y = b_csv[['OBP']]
