...
batting_info = mlb_battingstats[['Age','G','PA','1B','2B','3B','HR','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG','OBP','SLG','OPS','ISO','BABIP']]

b_x = batting_info[['Age','G','PA','1B','2B','3B','HR','R','RBI','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG','OBP','SLG','OPS','ISO','BABIP']]
b_y = batting_info[['BB']]
...
b_kbo_x = b_csv[['Age','G','PA','1B','2B','3B','HR','R','RBI','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG','OBP','SLG','OPS','ISO','BABIP']]
b_kbo_y = b_csv[['BB']]
