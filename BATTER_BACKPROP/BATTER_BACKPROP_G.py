...
batting_info = mlb_battingstats[['Age','AB','R','RBI','BB','IBB','SO','HBP','SF','SH','BABIP']]

b_x = batting_info[['Age','AB','PA','H','1B','2B','3B','HR','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG','OBP','SLG','OPS','ISO','BABIP']]
b_y = batting_info[['G']]
...
b_kbo_x = b_csv[['Age','AB','PA','H','1B','2B','3B','HR','R','RBI','BB','IBB','SO','HBP','SF','SH','GDP','SB','CS','AVG','OBP','SLG','OPS','ISO','BABIP']]
b_kbo_y = b_csv[['G']]
