...
batting_info = mlb_battingstats[['Age','PA','R','RBI','SO','HBP','SF','SH','GDP','SB','BABIP']]

b_x = batting_info[['Age','R','RBI','SO','HBP','SF','SH','GDP','SB','BABIP']]
b_y = batting_info[['PA']]
...
b_kbo_x = b_csv[['Age','R','RBI','SO','HBP','SF','SH','GDP','SB','BABIP']]
b_kbo_y = b_csv[['PA']]
