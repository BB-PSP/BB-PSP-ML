...
batting_info = mlb_pitchingstats[['Age','W','L','ERA','G','GS','CG','ShO','SV','BS','HLD','IP','TBF','H','R','ER','HR','BB','IBB','HBP','WP','BK','SO','K_9','WHIP','BABIP','LOB_PCT','FIP']]

b_x = batting_info[['Age','W','L','ERA','G','GS','CG','ShO','SV','BS','HLD','IP','TBF','H','R','ER','HR','BB','IBB','HBP','WP','BK','SO','K_9','BABIP','LOB_PCT','FIP']]
b_y = batting_info[['WHIP']]
...
kbo_pitchingstats = pd.read_csv(filepath_or_buffer="./DATA/PITCHERS_TOTAL.csv",encoding="utf_8",sep=",")
